...
parser.add_argument('--device', type=str, default="intel:cpu", help='Device to use')
parser.add_argument('--dataset', type=str, default='grapevinebunchdetection_reduced', help='Dataset to use')
